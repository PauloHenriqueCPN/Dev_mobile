...
public class TesteCalculadora {
    ...
    @Test
    public void meninoDoisAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(0.80, 9.0, 2,"masculino"));
    }
    ...
    @Test
    public void meninoQuatroAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(0.98, 13.0, 4,"masculino"));
    }
    ...
    @Test
    public void meninoSeisAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.08, 16.0, 6,"masculino"));
    }
    ...
    @Test
    public void meninoOitoAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.20, 19.0, 8,"masculino"));
    }
    ...
    @Test
    public void meninoDezAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.33, 25.0, 10,"masculino"));
    }
    ...
    @Test
    public void meninoDozeAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.42, 30.0, 12,"masculino"));
    }
    ...
    @Test
    public void meninaDoisAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(0.81, 9.0, 2,"feminino"));
    }
    ...
    @Test
    public void meninaQuatroAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(0.98, 13.0, 4,"feminino"));
    }
    ...
    @Test
    public void meninaSeisAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.07, 15.0, 6,"feminino"));
    }
    ...
    @Test
    public void meninaOitoAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.20, 19.0, 8,"feminino"));
    }
    ...
    @Test
    public void meninaDezAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.32, 24.0, 10,"feminino"));
    }
    ...
    @Test
    public void meninaDozeAnosAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.42, 30.0, 12,"feminino"));
    }
    ...
    @Test
    public void adultoAbaixoPesoMuitoGrave() {
        Assert.assertEquals("Abaixo do peso muito grave", calc.calcularImc(1.66, 44.0, 21,"masculino"));
    }

    @Test
    public void adultoAbaixoPesoGrave1() {
        Assert.assertEquals("Abaixo do peso grave", calc.calcularImc(1.65, 44.0, 25,"feminino"));
    }

    @Test
    public void adultoAbaixoPesoGrave2() {
        Assert.assertEquals("Abaixo do peso grave", calc.calcularImc(1.65, 46.0, 38,"feminino"));
    }

    @Test
    public void adultoAbaixoPeso1() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.76, 53.0, 54,"masculino"));
    }

    @Test
    public void adultoAbaixoPeso2() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.76, 57.0, 30,"masculino"));
    }
    ...
    @Test
    public void idosoAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.73, 65.0, 66,"masculino"));
    }
    ...
    @Test
    public void idosaAbaixoPeso() {
        Assert.assertEquals("Abaixo do peso", calc.calcularImc(1.67, 61.0, 69,"feminino"));
    }
